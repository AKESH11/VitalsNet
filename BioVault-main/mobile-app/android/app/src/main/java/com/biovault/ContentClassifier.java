...
public class ContentClassifier {
    ...
    private static ClassificationResult combinedDecision(float skinPct, MLKitScores ml) {
        ...
        // ════════════════════════════════════════════════════════════
        //  DECISION RULES (hybrid: pixel skin + ML Kit labels)
        // ════════════════════════════════════════════════════════════
        ...
        // ── EXPLICIT ──
        // Very high skin (≥45%) → nude / near-nude regardless of ML Kit
        if (skinPct >= 0.45f) {
        ...
        // High skin + ML Kit skin/body labels confirm it
        ...
        // ── SENSITIVE ──
        // Moderate-to-high skin (≥30%) → bikini, shirtless, suggestive
        if (skinPct >= 0.30f) {
        ...
        // ML Kit detects underwear/swimwear explicitly
        ...
        // Some skin + ML Kit skin labels (no clothing veto)
